...
export function CreateImagePromptModal({ defaultFolderId, onClose, onSave }: Props) {
  ...
  const [gender, setGender] = useState(defaultFolderId);
        ...
        <div className="p-6">
          <form onSubmit={handleSave} className="space-y-6">
            ...
            <div className="pt-4 border-t border-gray-800 flex justify-end gap-3">
              ...
              >
                {loading ? <Loader2 className="w-5 h-5 animate-spin" /> : <><Save className="w-5 h-5" /> Adicionar Foto</>}
              </button>
            </div>
